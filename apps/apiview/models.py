...
class BookAPI(models.Model):
    title = models.CharField(max_length=202)
    author = models.ForeignKey(AuthorAPI, on_delete=models.CASCADE, related_name='author')
    category = models.ForeignKey(CategoryAPI, on_delete=models.CASCADE, related_name='category')
